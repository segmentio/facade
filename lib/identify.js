 ...
 *
 * @example
 * const obj = { traits: { foo: "bar" }, anonymousId: "xxx" }
 * const identify = new Identify(obj)
 *
...
Identify.prototype.email = function () {
  const email = this.proxy("traits.email");
...
Identify.prototype.name = function () {
  const name = this.proxy("traits.name");
...
Identify.prototype.firstName = function () {
  const firstName = this.proxy("traits.firstName");
...
Identify.prototype.lastName = function () {
  const lastName = this.proxy("traits.lastName");
