...
Track.prototype.subtotal = function () {
  const subtotal = get(this.properties(), "subtotal");
  const total = this.total() || this.revenue();
...
Track.prototype.quantity = function () {
  const props = this.obj.properties || {};
 ...
 *
 * @example
 * const obj = { properties: { foo: "bar" }, anonymousId: "xxx" }
...
Track.prototype.properties = function (aliases) {
  const ret = this.field("properties") || {};
  aliases = aliases || {};
...
Track.prototype.revenue = function () {
  const revenue = this.proxy("properties.revenue");
